...
if eye==0 || eye==1 %LEFT EYE
    %vertical lines (binocular)
       ...
       Screen('FillRect', scr.w, sc(stim.fixL,scr.box), rectVL1); 
        Screen('FillRect', scr.w, sc(stim.fixL,scr.box), rectVL2); 
        ...
        polyCoord2L = [scr.LcenterXLine+stim.fixationOffset, scr.LcenterYLine; ...
            scr.LcenterXLine+stim.fixationOffset+round(stim.fixationLength), scr.LcenterYLine+stim.fixationLineWidth;...
            scr.LcenterXLine+stim.fixationOffset+round(stim.fixationLength), scr.LcenterYLine-stim.fixationLineWidth];
         Screen('FillPoly', scr.w ,sc(stim.fixL,scr.box), polyCoord1L, 1);
        Screen('FillPoly', scr.w ,sc(stim.fixL,scr.box), polyCoord2L, 1);
        
        %centre fixation zone (binocular circle)
         Screen('FrameOval', scr.w ,sc(stim.fixL,scr.box) ,[scr.LcenterXLine-maxi scr.LcenterYLine-maxi scr.LcenterXLine+maxi scr.LcenterYLine+maxi] ,stim.fixationLineWidth) ;

        %Middle fixation dot (binocular)
        if missingDot == 0
            if fixationColor == 0 %black 
                Screen('DrawDots', scr.w, [scr.LcenterXDot;scr.LcenterYDot], stim.fixationDotSize,sc(stim.fixL,scr.box));
            else %white
                Screen('DrawDots', scr.w, [scr.LcenterXDot;scr.LcenterYDot], stim.fixationDotSize,sc(stim.LmaxL,scr.box));
            end
        end
end
...
if eye==0 || eye==2 %RIGHT EYE
        ...
        rectVR2 = [scr.RcenterXLine-stim.fixationLineWidth/2, scr.RcenterYLine-stim.fixationOffset-stim.fixationLength ,...
         ...
         Screen('FillRect', scr.w, sc(stim.fixR,scr.box), rectVR1);
        Screen('FillRect', scr.w, sc(stim.fixR,scr.box), rectVR2); 
        ...
        Screen('FillPoly', scr.w ,sc(stim.fixR,scr.box), polyCoord1R, 1);
        Screen('FillPoly', scr.w ,sc(stim.fixR,scr.box), polyCoord2R, 1);
        
        %centre fixation zone (binocular circle)
            Screen('FrameOval', scr.w ,sc(stim.fixR,scr.box) ,[scr.RcenterXLine-maxi scr.RcenterYLine-maxi scr.RcenterXLine+maxi scr.RcenterYLine+maxi] ,stim.fixationLineWidth);

        %Middle fixation dot (binocular)
        if missingDot == 0
            if fixationColor == 0 %black 
                Screen('DrawDots', scr.w, [scr.RcenterXDot;scr.RcenterYDot], stim.fixationDotSize,sc(stim.fixR,scr.box));
            else %white
                Screen('DrawDots', scr.w, [scr.RcenterXDot;scr.RcenterYDot], stim.fixationDotSize,sc(stim.LmaxR,scr.box));
            end
        end
end
